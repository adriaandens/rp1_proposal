...
% TODO Sources
In many cases (\cite{proofpoint},\cite{foxittelegraaf},\cite{foxityahoo}), it was not the actual website but one of the advertisement networks that was infiltrated and which subsequently started serving malicious code hidden in innocently looking advertisement code. This is also called malvertising \cite{Li2012}.
