...
The goal during this research project is to make the algorithm platform agnostic. When this is not possible and during the development of the PoC we will focus on Windows 7 with version 8 of the Internet Explorer browser. This is at the time of writing one of the most used combinations in business in the Netherlands.
